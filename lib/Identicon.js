...
class Iqons {
    ...
    static placeholder (t = '#bbb', s = 1) {
        return `<svg viewBox="0 0 160 160" width="256" height="256" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/2000/xlink" >\n    <path fill="none" stroke="${t}" stroke-width="${2 *
...
Iqons.svgPath = 'http://localhost:'+ process.env.APP_PORT +'/img/iqons.min.svg';
